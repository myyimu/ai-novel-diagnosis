...
15. 除 JSON key、枚举值和必要英文专名外，所有面向作者阅读的自然语言字段必须使用简体中文；尤其是 hook、readerPromise、promise、nextCheck、risk、summary、reusablePattern、styleRules、safeRewriteMoves 不要输出英文句子。
`.trim();
  }
