...
- `workspace`: 项目、诊断历史/复诊资产、待确认方法卡和项目导出；真实正文版本与作者决定仍按产品计划补齐。
...
项目工作区接口负责持久化当前项目和诊断资产。目标契约还必须保存不可变正文版本、作者对 issue/finding 的决定、修改计划、实际采用项和独立复诊结果；缺少这些对象时不得把诊断历史表述为真实修改效果。方法卡只有经作者确认或多轮验证后才能进入长期库。
