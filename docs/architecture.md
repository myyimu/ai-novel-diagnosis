...
成熟样本拆解、Rubric、深度评分、整书拆解、图谱复核和样本研究是进阶能力，用来支撑更严肃的学习、质检和改稿决策，不作为首次使用入口。
...
方向说明见 [AI 网文诊断台定位与 AI 生成稿质检方向文档](./product-positioning-ai-draft-diagnosis.md)。主品牌继续讲“诊断”，功能文案承接 AI 生成稿质检和 Prompt 迭代。
