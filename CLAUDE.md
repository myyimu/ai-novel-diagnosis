...
| Project | Template | Per-project guide |
|---------|----------|-------------------|
| `apps/desktop` | `custom` | [`apps/desktop/CLAUDE.md`](apps/desktop/CLAUDE.md) |
| `apps/web` | `nextjs-app` | [`apps/web/CLAUDE.md`](apps/web/CLAUDE.md) |
| `packages/ai-core` | `ts-library` | [`packages/ai-core/CLAUDE.md`](packages/ai-core/CLAUDE.md) |
| `services/api` | `nestjs-api` | [`services/api/CLAUDE.md`](services/api/CLAUDE.md) |
<!-- one subprojects:end -->
