...
它的产品入口以“先救第一章”为主：用户粘贴自己的第一章，系统用 AI 小说诊断找出最大流失点，解释网文哪里不好、为什么可能没有流量，再复制可执行的改稿 Prompt；改完后再复诊，确认问题是否真的被解决。进阶能力再承接 AI 拆书、成熟样本质检、整书可视化拆解、关系图谱复核和导出资产。

## 主要视图

- 第一章改稿急诊室：粘贴章节、找最大流失点、生成改稿 Prompt、复诊对比。
