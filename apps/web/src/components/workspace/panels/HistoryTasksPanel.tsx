...
import { History, Clock, FileText, BookOpen, ExternalLink } from "lucide-react";
		...
		<div className="space-y-4">
			<Card>
				<CardHeader>
					...
					<CardDescription>已完成的诊断和分析任务</CardDescription>
				</CardHeader>
				<CardContent className="space-y-3">
					...
					<Button variant="outline" size="sm" className="w-full" onClick={onOpenHistory}>
						查看全部
